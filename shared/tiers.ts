 ...
 * Clinic  UGX 90,000/month  — 5 staff, unlimited patients, unlimited visits, 1 branch, reports
  ...
  switch (kind) {
    ...
    case "FEATURE": {
      const features: Record<string, string> = {
        smsLogs: "This feature is coming soon.",
        ...
        debtReminders: "Outstanding balance tracking is available on the Clinic plan (UGX 90,000/mo) or above.",
