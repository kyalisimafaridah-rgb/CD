...
import { Download, CheckCircle, Lock, Loader2, Smartphone } from "lucide-react";
  ...
  return (
    <Card id="subscription-card">
      ...
      <CardContent className="space-y-4">
        ...
        {renewsAt && paidActive && (
          <p className={`text-xs ${warning === "subscription_ending" ? "text-amber-700 font-medium" : "text-gray-500"}`}>
        ...
        <div className="border-t pt-4 space-y-4">
          <div>
            ...
            <div className="mt-3 rounded-md border border-green-300 bg-green-50 px-3 py-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              <div>
                <p className="text-[11px] uppercase tracking-wide text-gray-500">Pay to (MTN MoMo)</p>
            ...
            {clinicInfo?.name && (
              <div className="mt-3 rounded-md border border-green-200 bg-white px-3 py-2">
                <p className="text-[11px] uppercase tracking-wide text-gray-500">Use this as MoMo reason</p>
            ...
            <div className="rounded-lg border bg-green-50/40 p-3 space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                ...
                <div className="sm:col-span-2">
                  <label className="text-xs font-medium text-gray-600">MTN transaction ID (optional but helps matching)</label>
          ...
          {myRequests && myRequests.some((r) => r.status !== "pending") && (
            <div className="text-xs text-gray-500 space-y-1">
              <p className="font-medium text-gray-600">Recent requests</p>
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Used for phone dial codes and regional defaults</p>
              </div>
              <div>
        ...
        {/* SMS — coming soon for clinic users (provider wiring stays server-side) */}
        {canManage && (
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between gap-2">
                <div>
                  ...
                  <CardDescription>Appointment reminders and payment receipts by SMS</CardDescription>
                </div>
                <Badge className="bg-amber-100 text-amber-800 shrink-0">Coming soon</Badge>
              </div>
            </CardHeader>
            <CardContent className="space-y-2">
              <p className="text-sm text-gray-600">
                SMS sending will let you notify patients about appointments and share payment receipts automatically.
              </p>
              <p className="text-xs text-gray-500">
                This feature is not enabled for clinics yet. Everything else in CareDesk works without it.
              </p>
            </CardContent>
          </Card>
        )}
