...
import { getClinicAccessStatus, normaliseTier, getClinicTierLimits } from "./subscription";
...
export const appRouter = router({
  ...
  clinic: router({
    ...
    get: protectedProcedure.query(async ({ ctx }) => {
      ...
      return {
        ...clinic,
        accessWarning: access.allowed ? access.warning ?? null : null,
      };
    }),
    ...
    addBranch: protectedProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        const tier = normaliseTier(currentClinic?.subscriptionTier);
  ...
  visit: router({
    ...
    create: protectedProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        const visitTier = normaliseTier(clinicForLimit?.subscriptionTier);
  ...
  staff: router({
    ...
    acceptInvite: publicProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        const inviteTier = normaliseTier(inviteClinic?.subscriptionTier);
