...
export default function Home() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading CareDesk...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gradient-to-br from-green-100 to-blue-100 rounded-2xl p-8 h-80 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-muted-foreground font-medium">CareDesk Dashboard</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Features */}
      <section className="bg-card py-20 border-t border-gray-200">
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-foreground mb-3 text-center">Simple, honest pricing</h2>
          <p className="text-center text-muted-foreground mb-12">Start free. Upgrade when you're ready.</p>

          <div className="grid md:grid-cols-3 gap-6">

            {/* Free */}
            <div className="rounded-xl border-2 border-gray-200 bg-card p-7">
              <h3 className="text-xl font-bold text-foreground mb-1">Free</h3>
              <p className="text-3xl font-bold text-foreground mb-1">UGX 0</p>
            ...
            <div className="rounded-xl border-2 border-green-500 bg-green-50 shadow-lg p-7">
              ...
              <h3 className="text-xl font-bold text-foreground mb-1">Clinic</h3>
              <p className="text-3xl font-bold text-green-700 mb-1">UGX 90,000<span className="text-base font-normal text-muted-foreground">/mo</span></p>
            ...
            <div className="rounded-xl border-2 border-purple-400 bg-purple-50 p-7">
              ...
              <p className="text-3xl font-bold text-purple-700 mb-1">UGX 180,000<span className="text-base font-normal text-muted-foreground">/mo</span></p>
              <p className="text-xs text-muted-foreground mb-6">For growing clinic groups</p>
              <ul className="space-y-2 mb-8">
          ...
          <div className="mt-10 bg-card border border-gray-200 rounded-xl p-6 max-w-2xl mx-auto text-center">
            <p className="text-muted-foreground font-medium mb-2">💡 To put it in perspective</p>
            <p className="text-muted-foreground text-sm">A clinic seeing just <strong>3 patients a day</strong> at UGX 20,000 consultation fee earns UGX 1,800,000/month. CareDesk Clinic costs less than <strong>5% of one day's revenue</strong> to run the entire clinic.</p>
          </div>
        </div>
      </section>
