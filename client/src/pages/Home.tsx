      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-4">No card needed. Set up in minutes. Cancel anytime by simply not renewing.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
            {[
              ...
              { icon: Calendar, title: "Appointments", desc: "Schedule patient appointments, manage walk-ins, and keep your day organised. SMS reminders coming soon." },
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl border-2 border-green-500 bg-green-50 shadow-lg p-7">
              ...
              <ul className="space-y-2 mb-8">
                {["Up to 5 staff", "Unlimited patients", "Drug inventory management", "Revenue reports", "Activity audit log", "Debt tracking on bills"].map((f) => (
            ...
            <div className="rounded-xl border-2 border-purple-400 bg-purple-50 p-7">
              ...
              <ul className="space-y-2 mb-8">
                {["Unlimited staff", "Unlimited patients", "Unlimited branches", "All Clinic features", "Priority support", "Multi-branch management"].map((f) => (
                  <li key={f} className="flex items-center gap-2 text-sm text-gray-700">
