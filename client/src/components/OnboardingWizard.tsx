...
export function OnboardingWizard() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-card rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
        {/* Progress */}
        ...
        <div className="px-6 py-6 min-h-[320px]">
          ...
          {step === "clinic" && (
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-green-700">
                ...
                <h2 className="text-xl font-bold text-foreground">Clinic details</h2>
              </div>
              ...
              <div className="rounded-lg border bg-muted px-3 py-2">
                <p className="text-[11px] uppercase text-muted-foreground">Clinic name</p>
              ...
              <div className="grid gap-3">
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">Used as the starting fee when you log a visit.</p>
                </div>
              </div>
            </div>
          )}
          ...
          {step === "workflow" && (
            <div className="space-y-4">
              <h2 className="text-xl font-bold text-foreground">How a normal day works</h2>
              <p className="text-sm text-muted-foreground">Three screens cover most of the work:</p>
          ...
          {step === "team" && (
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-green-700">
                ...
                <h2 className="text-xl font-bold text-foreground">Your team</h2>
              </div>
              <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <p className="text-xs text-center text-muted-foreground">Or continue setup and invite later.</p>
            </div>
          )}

          {step === "plan" && (
            <div className="space-y-4">
              <h2 className="text-xl font-bold text-foreground">You&apos;re on the Free plan</h2>
              <p className="text-sm text-muted-foreground">
        ...
        {/* Footer nav */}
        {step !== "done" && (
          <div className="px-6 py-4 border-t bg-muted flex justify-between gap-2">
            <Button
              variant="ghost"
